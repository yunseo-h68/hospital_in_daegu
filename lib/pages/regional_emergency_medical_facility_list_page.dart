...
import 'package:hospitalindaegu/data/regional_emergency_medical_facility_list_page.dart';
import 'package:hospitalindaegu/pages/hospital_detail_page.dart';

class RegionalEmergencyMedicalFacilityListPage extends StatelessWidget {
  final List<Map<String, dynamic>> items = remfData;
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '대구 지역에는 지역응급의료시설이 7곳 존재합니다. 찾고자 하는 곳을 클릭하여 자세한 정보를 확인하세요.',
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'SN BeolBeolJeongJik',
                        fontSize: 20.0,
