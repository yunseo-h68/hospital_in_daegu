...
import 'package:hospitalindaegu/data/regional_medical_center_list_data.dart';

import 'hospital_detail_page.dart';

class RegionalMedicalCenterListPage extends StatelessWidget {
  final List<Map<String, dynamic>> items = rmcData;
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      '대구 지역에는 권역응급 의료센터가 1곳 존재합니다. 찾고자 하는 곳을 클릭하여 자세한 정보를 확인하세요.',
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'SN BeolBeolJeongJik',
                        fontSize: 20.0,
